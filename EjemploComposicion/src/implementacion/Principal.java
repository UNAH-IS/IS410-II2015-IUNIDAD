...
public class Principal {
	...
	public void agregarLibro(){
		...
		*/
		libro.solicitarInformacion(new Libro());
		libros.add(libro);
		mostrarInformacion();
	}
	...
	public void modificarLibro(){
		...
		//Mostrar Informacion
		int indice = Integer.valueOf(JOptionPane.showInputDialog("Que indice desea modificar? (0 al "+(libros.size()-1))+")");
		Libro libro = new Libro();
	...
	public void eliminarLibro(){
		...
		int indice = Integer.valueOf(JOptionPane.showInputDialog("Que indice desea eliminar? (0 al "+(libros.size()-1)+")"));
